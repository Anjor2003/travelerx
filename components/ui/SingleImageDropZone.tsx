        ...
        >
          ...
          {imageUrl ? (
            ...
            <div className="flex flex-col items-center justify-center text-xs text-gray-400">
              ...
              <div className="text-gray-400 text-base">drag & drop to upload</div>
              <div className="mt-3">
  ...
  return (
    <button
      className={twMerge(
        ...
        // color
        "border border-orange-400 text-tertiary shadow hover:bg-primary hover:text-white",
        // size
        "h-6 rounded-md px-2 text-base",
        className
      )}
      ref={ref}
      {...props}
